...
async def fban_(message: Message):
    ...
    message.flags
    fban_arg = ["â¯", "â¯â¯", "â¯â¯â¯", "â¯â¯â¯ <b>FBanned {}</b>"]
...
async def fban_m(message: Message):
    ...
    if not message.reply_to_message:
        ...
        return
    fban_arg = ["â¯", "â¯â¯", "â¯â¯â¯", "â¯â¯â¯ <b>FBan complete</b>"]
...
async def unfban_(message: Message):
    ...
    fban_arg = ["â¯", "â¯â¯", "â¯â¯â¯", "â¯â¯â¯ <b>Un-FBanned {}</b>"]
    await message.edit(fban_arg[0])
